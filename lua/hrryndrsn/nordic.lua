...
Color.new('fg', "#292929")
Color.new('nord_0', "#1d1f21")
Color.new('nord_1',"#282a2e")
Color.new('nord_2', "#373b41")
Color.new('nord_3', "#969896")
Color.new('nord_3_light', "#616E88")
Color.new('nord_4', "#b4b7b4")
Color.new('nord_5', "#c5c8c6")
Color.new('nord_6', "#e0e0e0")
Color.new('nord_7', "#ffffff")
Color.new('nord_8', "#cc6666")
Color.new('nord_9', "#de935f")
Color.new('nord_10', "#f0c674")
Color.new('nord_11', "#b5bd68")
Color.new('nord_12', "#8abeb7")
Color.new('nord_13', "#81a2be")
Color.new('nord_14', "#b294bb")
Color.new('nord_15', "#a3685a")
